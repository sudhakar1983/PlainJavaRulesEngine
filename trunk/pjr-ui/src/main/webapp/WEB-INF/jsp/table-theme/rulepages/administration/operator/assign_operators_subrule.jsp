...
<table width="100%" id="table" class="ruletable" cellspacing="0">
	...
	<tr>
		...
		<A href="#table" style="color:white;" onclick="selectAll('operatorsToAssignFromRequest');">Select All</A>
		|
		<A href="#table" style="color:white;" onclick="clearAll('operatorsToAssignFromRequest');">Clear All</A>
		)
		</th>		
	</tr>	
