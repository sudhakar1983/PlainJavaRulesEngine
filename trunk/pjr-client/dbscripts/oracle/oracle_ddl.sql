...
CREATE TABLE RE_MODEL_CLASS 
    ( 
     ...
     MODEL_CLASS_NAME VARCHAR2 (200 BYTE)  NOT NULL 
    ) 
        TABLESPACE USERS 
        LOGGING 
;
ALTER TABLE RE_MODEL_CLASS 
    ADD CONSTRAINT RE_MODEL_CLASS_PRMKEY PRIMARY KEY ( MODEL_ID ) ;
...
ALTER TABLE RE_OBECT_ATTR 
    ADD CONSTRAINT ATTR_FRGN_KEY FOREIGN KEY ( MODEL_ID ) REFERENCES RE_MODEL_CLASS (MODEL_ID);    
...
ALTER TABLE RE_RULES 
    ADD CONSTRAINT RULES_FRGN_KEY_MODEL FOREIGN KEY ( MODEL_ID ) REFERENCES RE_MODEL_CLASS (MODEL_ID);    
...
ALTER TABLE RE_SUBRULE 
    ADD CONSTRAINT SUBRULES_FRGN_KEY FOREIGN KEY ( MODEL_ID ) REFERENCES RE_MODEL_CLASS (MODEL_ID);
...
CREATE SEQUENCE SUBRULE_OPR_MAPPING_PK_SQ 
    ...
    NOCACHE 
;
CREATE SEQUENCE MODEL_CLASS_PK_SQ 
    INCREMENT BY 1 
    START WITH 2000
    MAXVALUE 999999999999999999999999999 
    MINVALUE 1 
