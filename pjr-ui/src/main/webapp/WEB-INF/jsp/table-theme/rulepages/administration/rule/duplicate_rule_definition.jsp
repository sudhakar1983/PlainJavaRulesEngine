...
<form:form commandName="rule" name="createForm" id="createForm" method="post" acceptCharset="UTF-8" action="duplicate">
<br/><br/>
<c:choose>
...
<br/>
<input type="hidden" name="ruleIdToCopy" value="${ruleIdToCopy }" />
